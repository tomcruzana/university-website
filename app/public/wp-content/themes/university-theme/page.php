...
<div class="container container--narrow page-section">
    ...
    if ($the_parent_ID) { ?>
        <div class="metabox metabox--position-up metabox--with-home-link">
            <p>
                <a class="metabox__blog-home-link" href="<?php echo get_permalink($the_parent_ID); ?>"><i class="fa fa-home"
                        aria-hidden="true"></i> Back to
                    <?php
                    // returns the string name based on the post or parent id
                    echo get_the_title($the_parent_ID) ?>
    ...
    if ($the_parent_ID or $testArray) { ?>
        <div class="page-links">
            <h2 class="page-links__title"><a href="<?php echo get_permalink($the_parent_ID); ?>">
